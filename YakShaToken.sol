...
contract Blacklistit is Ownable{
...
contract YakshaToken is IBEP20, Context, Ownable, TokensRecoverable, Pausable, Blacklistit{
  using SafeMath for uint256;
  using SafeBEP20 for IBEP20;
  ...
  constructor() {
    ...
    _symbol = "YAK";
    _decimals = 18;
    _totalSupply = 8900000000 *  10  ** uint256(_decimals);
